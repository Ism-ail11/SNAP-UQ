...
class SpeechCommandsWrapper(Dataset):
    ...
    def __init__(
        ...
        # Single pass: collect all labels, then build class mapping and target list
        all_labels = [item[2] for item in self.ds]
        ...
        self._targets = [self.class_to_idx.get(label, -1) for label in all_labels]
